...
const HOMES = [
  ...
  {
    owner: 'chloe',
    title: 'Maison de ville avec cour pavée',
    description:
      "Maison nantaise sur trois niveaux, à dix minutes à pied du Jardin des Plantes. La cour se transforme en salle à manger dès les beaux jours.",
    address: 'Rue du Calvaire 18',
    city: 'Nantes',
    country: 'France',
    latitude: 47.2158,
    longitude: -1.5589,
    ...
    homeType: 'HOUSE',
    category: 'CITY',
    amenities: ['wifi', 'kitchen', 'washingMachine', 'garden'],
    pricePerNight: 110,
    averageRating: 4.6,
    reviewsCount: 9,
    carExchangeAccepted: false,
    photos: [IMG.maison2, IMG.salonCosy, IMG.chambre2],
    availabilities: [
      [12, 60],
    ],
  },
  {
    owner: 'karim',
    title: 'Appartement lumineux face au château',
    description:
      "Deux chambres au quatrième étage, sans vis-à-vis, avec le château des ducs par la fenêtre du salon. Marché le samedi en bas de l'immeuble.",
    address: 'Place du Change 6',
    city: 'Nantes',
    country: 'France',
    latitude: 47.2159,
    longitude: -1.5583,
    ...
    reviewsCount: 6,
    carExchangeAccepted: true,
    photos: [IMG.salonLumineux, IMG.cuisine, IMG.chambre3],
    availabilities: [
      [20, 75],
    ],
  },
  {
    owner: 'ines',
    title: 'Loft d’artiste sur l’île de Nantes',
    description:
      "Ancien atelier reconverti, sept mètres sous plafond et une mezzanine. Les Machines de l'île sont à cinq minutes à pied.",
    address: 'Boulevard Léon Bureau 21',
    city: 'Nantes',
    country: 'France',
    latitude: 47.2069,
    longitude: -1.5652,
    ...
    homeType: 'LOFT',
    category: 'CITY',
    amenities: ['wifi', 'kitchen', 'workspace', 'washingMachine'],
    pricePerNight: 88,
    averageRating: 4.8,
    reviewsCount: 11,
    carExchangeAccepted: false,
    photos: [IMG.interieur, IMG.salon, IMG.cuisine2],
    availabilities: [
      [8, 50],
    ],
  },
  {
    owner: 'bruno',
    title: 'Pavillon familial à Chantenay',
    description:
      "Quartier calme et résidentiel, jardin clos pour les enfants, garage pour deux vélos et une voiture. Tram à trois cents mètres.",
    address: 'Rue Louis Blanc 44',
    city: 'Nantes',
    country: 'France',
    latitude: 47.2019,
    longitude: -1.5884,
    ...
    homeType: 'HOUSE',
    category: 'CITY',
    amenities: ['wifi', 'kitchen', 'garden', 'garage', 'washingMachine'],
    pricePerNight: 130,
    averageRating: 4.2,
    reviewsCount: 7,
    carExchangeAccepted: true,
    photos: [IMG.maison3, IMG.salonLumineux, IMG.chambre],
    availabilities: [
      [25, 95],
    ],
  },
  {
    owner: 'mila',
    title: 'Studio rénové quartier Graslin',
    description:
      "Trente mètres carrés repensés, à deux pas de l'opéra et des brasseries. Idéal pour un séjour court en centre-ville.",
    address: 'Rue Crébillon 12',
    city: 'Nantes',
    country: 'France',
    latitude: 47.2131,
    longitude: -1.5619,
    ...
    reviewsCount: 5,
    carExchangeAccepted: false,
    photos: [IMG.canape, IMG.sallePain],
    availabilities: [
      [3, 40],
    ],
  },
